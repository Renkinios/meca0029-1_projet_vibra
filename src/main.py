...
# print("relative_error_gi : [%]", relative_error_gi*100,"\n")
...
# print("Relative error between the w and Craig Bampton [%]:", relative_error_cb*100,"\n")
...
t_end = time.time()
delta_t = t_end - t_app
# print("temps de calcul de la methode de newmark :", t_q_delta)
# print("temps de calcul de la methode de newmark avec Craig_Bampton :", delta_t)
